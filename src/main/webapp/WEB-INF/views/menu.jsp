...
<body>
	...
	<nav id="menu-bar">
		<ul id="fancyNav">
			...
			<!-- Update Prices menu -->		
			<c:choose>
				<c:when test="${menuState=='PRICE_UPDATE'}">          
					<li id="PRICE_UPDATE_MENU" class="selected">
						<a href="#" id="selected">
							<span>
								<img src="resources/images/downLoadPrices.png" height="28px" width="25px"/> Update Prices
							</span>
						</a>
					</li>
				</c:when>
				<c:otherwise>
					<li id="PRICE_UPDATE_MENU">
						<a href="<c:url value='/updatePrices.html'/>"> 
							<span>
								<img src="resources/images/downLoadPrices.png" height="28px" width="25px"/> Update Prices
							</span>
						</a>
