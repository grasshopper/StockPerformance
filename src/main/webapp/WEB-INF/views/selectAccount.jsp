...
<script type="text/javascript">
	...
	function stockSelectionChange(object) {
		...
		*/
		...
		alert("Making an Ajax call for URL viewStocksMovingAverage.html from selectAccount.jsp function stockSelectionChange");
		...
		$.ajax({
            ...
            error: function (jqxhr, status, errorThrown) {
				console.log("Failure, unable to recieve content");
		...
		*/
		...
		alert("Making an Ajax call for URL viewStocksMovingAverage.html from selectAccount.jsp function stockSelectionChange 2");
		
		// make the ajax call to get graph data as json object		
		$.ajax({
			type : 'GET',
			url : 'stockGraphData', 
			data : "stockIds=" + checkValues,
